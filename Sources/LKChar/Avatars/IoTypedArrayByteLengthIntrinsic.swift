...
class IoTypedArrayByteLengthIntrinsic: HeMonoDwarfWriter {
    ...
    override func setValue(_ value: Any?, forKey key: String) {
        ...
        }else if key == hEnsurePermission{
            super.setValue(value, forKey: "kWindowElevation")
